          ...
          <main className="pt-20">
                ...
                <span className="relative flex h-2 w-2">
                  ...
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-orange-500"></span>
                          ...
                          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight">
                              Traduzco lógica de negocio en <br />
                  ...
                  soluciones tecnológicas.
                          ...
                          <div className="flex flex-wrap gap-4">
                              <a href="#proyectos" className="flex items-center gap-2 px-8 py-4 bg-white text-black font-bold rounded-xl hover:bg-orange-500 hover:text-white transition-all transform hover:-translate-y-1">
                                  Ver Proyectos
                              </a>
                      ...
                      <div className="md:col-span-4 flex justify-center">
                          <div className="relative w-64 h-64 md:w-80 md:h-80">
                              <div className="absolute inset-0 bg-gradient-to-tr from-orange-500/40 to-purple-600/40 rounded-3xl rotate-6 animate-pulse"></div>
                              <div className="absolute inset-0 bg-[#1e1e22] border border-white/10 rounded-3xl flex items-center justify-center overflow-hidden">
                                  <Code2 size={120} className="text-white/20" />
                                  <div className="absolute bottom-4 left-4 right-4 p-4 bg-black/40 backdrop-blur-md rounded-xl border border-white/5">
                                      <div className="text-xs font-bold text-white mb-1 uppercase tracking-tighter">Stack Principal</div>
              ...
              <section id="proyectos" className="py-24 px-6">
                  <div className="max-w-7xl mx-auto">
                      ...
                      <div>
                          <div className="flex items-center gap-4 mb-10">
                              <div className="h-px flex-grow bg-gradient-to-r from-transparent to-purple-500/50"></div>
                              <h2 className="text-2xl md:text-3xl font-bold text-white flex items-center gap-3 italic">
              ...
              <section id="contacto" className="py-24 px-6 relative overflow-hidden">
                  ...
                  <div className="max-w-3xl mx-auto text-center">
                      <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 italic tracking-tight">¿Hablamos de negocios o de código?</h2>
                      <p className="text-gray-400 mb-12 text-lg">
                          Estoy buscando mi primera oportunidad profesional donde pueda aportar mi criterio técnico y visión comercial.
                          Si buscas un Junior con pensamiento crítico, envíame un mensaje.
                      </p>

                      <div className="grid md:grid-cols-3 gap-4 mb-12">
                          <a href="mailto:tu-email@dominio.com" className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-[#1e1e22] border border-white/5 hover:bg-white/10 transition-all">
                              <Mail className="text-orange-500" />
                              <span className="text-sm font-medium">Email</span>
                          </a>
                          <a href="#" className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-[#1e1e22] border border-white/5 hover:bg-white/10 transition-all">
                      ...
                      <button className="w-full p-8 rounded-3xl bg-gradient-to-tr from-orange-600 to-rose-600 text-white font-bold text-xl cursor-pointer hover:shadow-2xl hover:shadow-orange-500/20 transition-all">
              ...
              <section className="py-24 px-6 bg-[#0d0d0f] border-t border-white/5">
                  <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
                      <div className="relative group shrink-0">
                          <div className="absolute inset-0 bg-orange-500/20 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform"></div>
                          <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-2xl overflow-hidden border border-white/10 bg-[#1e1e22]">
                              <Image
                      ...
                      <div className="flex-grow space-y-4 text-center md:text-left">
                          <div className="inline-block px-3 py-1 rounded-md bg-white/5 text-[10px] text-gray-500 uppercase tracking-[0.2em] font-bold">
                              Sobre el autor
                          </div>
                          <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-medium">
                              Creo que el código es una herramienta de precisión, pero el propósito de cualquier sistema debe ser siempre humano.
